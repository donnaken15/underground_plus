	...
	splitscreen_game_type_info = [
		...
		{name = "FireFight" checksum = firefight}
	]
	time_limit_options = [
	...
	capture_options = [
		{name = "1 capture" checksum = score_1 score = 1}
		{name = "2 captures" checksum = score_2 score = 2}
		{name = "5 captures" checksum = score_5 score = 5}
		{name = "10 captures" checksum = score_10 score = 10}
		{name = "25 captures" checksum = score_25 score = 25}
	]
	target_score_options = [
		{name = "100,000 pts" checksum = score_100000 score = 100000}
		{name = "250,000 pts" checksum = score_250000 score = 250000}
		{name = "500,000 pts" checksum = score_500000 score = 500000}
		{name = "1,000,000 pts" checksum = score_1000000 score = 1000000}
		{name = "2,000,000 pts" checksum = score_2000000 score = 2000000}
		{name = "5,000,000 pts" checksum = score_5000000 score = 5000000}
		{name = "10,000,000 pts" checksum = score_10000000 score = 10000000}
		{name = "50,000,000 pts" checksum = score_50000000 score = 50000000}
		{name = "100,000,000 pts" checksum = score_100000000 score = 100000000}
	]
