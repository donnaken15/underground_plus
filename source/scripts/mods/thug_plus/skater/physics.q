	...
	skater_physics = {
		...
		Physics_Transfer_Speed_Limit_Override_Max = 75.75
	}
	...
	Skater_Camera_Undefined = {
		...
		slerp = 0.01,
		vert_air_slerp = 0.01,
		vert_air_landed_slerp = 0.035,
		lerp_xz = 0.09,
		lerp_y = 0.05,
		vert_air_lerp_xz = 0.06,
		vert_air_lerp_y = 0.04,
		zoom_lerp = 0.005,
		big_air_trick_zoom = 2.70000005,
		lip_trick_zoom = 6.0,
		lip_trick_tilt = 0.45000002,
		lip_trick_above = 1.29999995,
	...
	Skater_Camera_UGPlus_MediumZoom = {
		...
		vert_air_lerp_y = 1.0,
		zoom_lerp = 0.0125,
		big_air_trick_zoom = 1.70000005,
		lip_trick_zoom = 0.5,
		lip_trick_tilt = -0.80000001,
		lip_trick_above = 0.40000001,
		grind_zoom = 0.5,
		origin_offset = 0.2,
		name = "standard"}
	Skater_Camera_UGPlus_Far = {
		...
		lerp_xz = 0.25,
		lerp_y = 0.15000001,
		vert_air_lerp_xz = 0.055,
		vert_air_lerp_y = 0.08,
		zoom_lerp = 0.0625,
		big_air_trick_zoom = 0.69999999,
		lip_trick_zoom = 1.0,
		lip_trick_tilt = -0.80000001,
		lip_trick_above = 0.40000001,
		grind_zoom = 1.0,
	...
	Skater_Camera_UGPlus_Near = {
		...
		tilt = 0.18000001,
		slerp = 0.02,
		vert_air_slerp = 0.005,
		vert_air_landed_slerp = 0.015,
		lerp_xz = 0.25,
		lerp_y = 0.1,
		vert_air_lerp_xz = 0.1,
		vert_air_lerp_y = 0.1,
		zoom_lerp = 0.0025,
		big_air_trick_zoom = 0.89999998,
		lip_trick_zoom = 4.5999999,
		lip_trick_tilt = -0.80000001,
		lip_trick_above = 1.20000005,
		grind_zoom = 1.0,
		origin_offset = 0.2,
		name = "near"}
	...
	Skater_Camera_UGPlus_New = {
		...
		slerp = 0.0,
		vert_air_slerp = 0.0,
		vert_air_landed_slerp = 0.01,
		lerp_xz = 0.0,
		lerp_y = 0.0,
		vert_air_lerp_xz = 0.005,
		vert_air_lerp_y = 0.005,
		zoom_lerp = 0.0625,
		big_air_trick_zoom = 0.89999998,
		lip_trick_zoom = 1.60000002,
		lip_trick_tilt = 0.0,
		lip_trick_above = 0.40000001,
		grind_zoom = 1.0,
		origin_offset = 0.2,
	...
	Skater_Camera_UGPlus_New2 = {
		...
		slerp = 0.0,
		vert_air_slerp = 0.04,
		vert_air_landed_slerp = 0.1,
		lerp_xz = 0.25,
		lerp_y = 0.75,
		vert_air_lerp_xz = 0.01,
		vert_air_lerp_y = 0.01,
		zoom_lerp = 0.0625,
		big_air_trick_zoom = 0.69999999,
		lip_trick_zoom = 1.29999995,
		lip_trick_tilt = 0.0,
		lip_trick_above = 0.40000001,
		grind_zoom = 1.5,
	...
	Skater_Camera_UGPlus_LTG = {
		...
		vert_air_landed_slerp = 0.075,
		lerp_xz = 0.25,
		lerp_y = 0.15000001,
		vert_air_lerp_xz = 0.69999999,
		vert_air_lerp_y = 0.60000002,
		zoom_lerp = 0.0225,
		big_air_trick_zoom = 0.60000002,
		lip_trick_zoom = 1.0,
		lip_trick_tilt = -0.80000001,
		lip_trick_above = 0.40000001,
		grind_zoom = 1.0,
	...
	Skater_Camera_UGPlus_FirstPerson = {
		...
		slerp = 0.39999998,
		vert_air_slerp = 1.0,
		vert_air_landed_slerp = 0.99000001,
		lerp_xz = 1.0,
		lerp_y = 0.96000004,
		vert_air_lerp_xz = 1.0,
		vert_air_lerp_y = 0.60000002,
		zoom_lerp = 0.89999998,
		big_air_trick_zoom = 2.70000005,
		lip_trick_zoom = 1.0,
		lip_trick_tilt = 0.45000002,
		lip_trick_above = 5.29999971,
		grind_zoom = 1.89999998,
		origin_offset = 100.19999695,
		name = "first person"}
