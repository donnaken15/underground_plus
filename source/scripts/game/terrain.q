	...
	script SetTerrainGrass
		...
		SetTerrainParticleProperties {
			terrain = TERRAIN_GRASS num = 200 start_col = -15259859 end_col = 931772970 emit_w = 2.0 emit_h = 2.0999999
			size = 6 aspect_ratio = 1 growth = 1.0 angle = -50.0 speed = 60.0 speed_range = 60.0 life = 0.89999998 grav = -0.5
			name = "Grass_1.png"}
	endscript
	script SetTerrainGrassDried
		LoadTerrainSounds terrain = TERRAIN_GRASSDRIED
		SetTerrainParticleProperties {
			terrain = TERRAIN_GRASSDRIED num = 200 start_col = -15259859 end_col = 931772970 emit_w = 2.0 emit_h = 2.0999999
			size = 6 aspect_ratio = 1 growth = 1.0 angle = -50.0 speed = 60.0 speed_range = 60.0 life = 0.89999998 grav = -0.5
			name = "Grass_1.png"}
	endscript
	script SetTerrainDirt
		...
		SetTerrainParticleProperties {
			terrain = TERRAIN_DIRT num = 20 start_col = 1516740274 end_col = 6793906 emit_w = 1.0 emit_h = 1.0
			size = 25 aspect_ratio = 1.0 growth = 2.0 angle = 90.0 speed = 30.0 speed_range = 50.0 life = 0.60000002 grav = 0.5
			name = "breath.png"}
	endscript
	script SetTerrainDirtPacked
		LoadTerrainSounds terrain = TERRAIN_DIRTPACKED
		SetTerrainParticleProperties {
			terrain = TERRAIN_DIRTPACKED num = 20 start_col = 1516740274 end_col = 6793906 emit_w = 1.0 emit_h = 1.0
			size = 25 aspect_ratio = 1.0 growth = 2.0 angle = 90.0 speed = 30.0 speed_range = 50.0 life = 0.60000002 grav = 0.5
			name = "breath.png"}
	endscript
	script SetTerrainWater
		...
		SetTerrainParticleProperties {
			terrain = TERRAIN_WATER num = 200 start_col = -1008349527 end_col = 166055593 emit_w = 2.0 emit_h = 5.0
			size = 3 aspect_ratio = 0.44999999 growth = 2.0 angle = 45.0 speed = 90.0 speed_range = 60.0 life = 0.60000002 grav = 0.0
			name = "breath.png"}
	endscript
	...
	script SetTerrainSnow
		...
		SetTerrainParticleProperties {
			terrain = TERRAIN_SNOW num = 20 start_col = 1526327776 end_col = 217704928 emit_w = 1.0 emit_h = 1.0
			size = 21 aspect_ratio = 0.69999999 growth = 2.0 angle = 60.0 speed = 30.0 speed_range = 50.0 life = 0.69999999 grav = 2
			name = "breath.png"}
	endscript
	script SetTerrainSand
		LoadTerrainSounds terrain = TERRAIN_SAND
		SetTerrainParticleProperties {
			terrain = TERRAIN_SAND num = 20 start_col = 1516740274 end_col = 6793906 emit_w = 1.0 emit_h = 1.0
			size = 25 aspect_ratio = 1.0 growth = 2.0 angle = 90.0 speed = 30.0 speed_range = 50.0 life = 0.60000002 grav = 0.5
			name = "breath.png"}
	endscript
