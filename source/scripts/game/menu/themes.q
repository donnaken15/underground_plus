	...
	script swap_themes_menu
		...
		make_new_themed_scrolling_menu title = "INTERFACE THEMES" title_icon = <title_icon>
		...
		common_params = {pad_choose_script = set_current_theme centered = 1 no_bg = no_bg highlight_bar_scale = (2.29999995,0.69999999)}
	...
	script set_current_theme
		...
		change last_theme_prefix = (current_theme_prefix + 0)
