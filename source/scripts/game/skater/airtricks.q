	...
	Trick_FSBigSpin = {Scr = FlipTrick Params = {Name = 'BS Bigspin' Score = 500 Anim = FSBigSpin Speed = 1.20000005 FlipAfter maxspeed = 2 ExtraTricks = Extra540ShoveIt}}
	Trick_BSBigSpin = {Scr = FlipTrick Params = {Name = 'FS Bigspin' Score = 500 Anim = BSBigSpin Speed = 1.39999998 FlipAfter maxspeed = 2 ExtraTricks = ExtraFS540ShoveIt}}
	...
	Trick_360Varial = [{Trigger_Extra_Flip Params = {Name = '360 Varial' Score = 900 Anim = _360Varial Speed = 0.89999998 trickslack = 25 boardrotate IsExtra UseCurrent}}]
