	...
	Editor_Set_Names = [
		...
		}
		{
			set = BigOb3
			name = 'Trailers'
			row_scale = 2.20000005
			selected_scale_mult = 1.0
		}
		{
			set = Funboxes
			name = 'Funboxes'
			row_scale = 1.20000005
			selected_scale_mult = 1.0
		}
		{
			set = FunboxesG
	...
	Editor_Light_Info = [
		[
			{
				ambient_const = 0.5
				ambient_rgb = (1.0,1.0,0.95999998)
				falloff_const = 160000.0
				falloff_rgb = (0.38999999,0.38,0.31999999)
				cursor_ambience = 1.5
				pos = [
					(6.0,10.0,6.0)
					(6.0,10.0,-6.0)
		...
		[
			{
				ambient_const = 0.89999998
				ambient_rgb = (0.89999998,0.89999998,1.0)
				falloff_const = 90000.0
				falloff_rgb = (0.44999999,0.44999999,0.31999999)
				cursor_ambience = 1.5
				pos = [
					(4.0,10.0,4.0)
					(12.0,10.0,4.0)
		...
		[
			{
				ambient_const = 1.29999995
				ambient_rgb = (0.95999998,0.95999998,1.0)
				falloff_const = 150000.0
				falloff_rgb = (0.30000001,0.30000001,0.30000001)
				cursor_ambience = 1.5
				pos = [
					(4.0,10.0,4.0)
					(12.0,10.0,4.0)
